...
const syllablesData = {
    ...
    'П': { 'А': {word:'паук',icon:'spider'}, 'О': {word:'помидор',icon:'tomato'}, 'У': {word:'пуговица',icon:'disc'}, 'И': {word:'пингвин',icon:'penguin'}, 'Е': {word:'перо',icon:'feather'}, 'Ы': null, 'Ю': null, 'Э': null, 'Я': {word:'пять',icon:'hash'}, 'Ё': {word:'пёс',icon:'dog'} },
